...
Route::get('/voirEntreprise/{id}', 'MainController@voirEntreprise');
Route::get('/vueEntreprise', 'MainController@vueEntreprise');
...
Route::get('/afficherDemande/{id}', 'MainController@afficherDemande');
Route::get('/affichageDemande', 'MainController@affichageDemande');
...
Route::post('/rechercherEntreprise', 'MainController@rechercherEntreprise');
Route::get('/liste_entreprises', 'MainController@listeEntreprises');
Route::get('/telechargerPiece/{id}', 'MainController@telechargerPiece');
